...
/**
 * JoinedEventsFragment displays a list of events that the user has joined.
 * This fragment retrieves the joined events from Firestore based on the user's device ID
...
public class JoinedEventsFragment extends Fragment {
     ...
     * Loads the user's joined events from Firestore.
     *
    ...
    /**
     * Loads the user's joined events from the "joinedEvents" subcollection in Firestore.
